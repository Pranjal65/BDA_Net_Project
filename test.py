...
def main(config, args):
    ...
    model1 = FCN_backbone.SiameseFCN_damage(
    ...
    model2 = FCN_backbone.SiameseFCN_damage(
        config.input_channel,
        out_channel,
        backbone="vgg16_bn",
        pretrained=True,
...
if __name__ == "__main__":
    ...
    pathCkpt = r"/home/pranjalmore/Pranjal/ClgProject/MS4D-Net-Building-Damage-Assessment\save/Si_FCN_Dam_vgg16_bn_diff_PDMT/20250227_000453/checkpoint-best.pth"
    ...
    parser.add_argument(
        "-is_test", action="store_true", default=True, help="in test mode, is_test=True"
    )
    if config.use_gpu:
        parser.add_argument(
            "-gpu",
